...
_.extend(bbGrid.View.prototype, Backbone.View.prototype, {
    ...
    render: function(){
        ...
        if(!this.$grid){
            this.$grid = $('<table class="bbGrid-grid table table-bordered table-striped" />');
            if(this.caption)
        ...
        if(!this.$navBar){
            ...
            this.$loading = $('<div class="bbGrid-loading progress progress-info progress-striped active"><div class="bar bbGrid-loading-progress">数据加载中...</div></div>');
...
//            this.$grid.before(this.$topbar);
    ...
    showCollection: function(collection){
        ...
        if(collection.length == 0 && !this.autofetch){
            ...
            this.$grid.append('<tbody><tr class="bbGrid-noRows"><td colspan="'+colspan+'"></td></tr></tbody>');
        }
    },
    ...
    initPager: function() {
        ...
        var pager = _.template('<div class="span bbGrid-pager">\
            <ul class="nav nav-pills">\
                ...
                <li>\
                    <div class="bbGrid-page-counter pull-left">第</div>\
                    <input class="bbGrid-page-input" value="<%=page%>" type="text">\
                    <div class="bbGrid-page-counter pull-right">页 共<%=cntpages%>页</div>\
                </li>\
            ...
            <% if(rowlist){%>\
                <div class="bbGrid-pager-rowlist-label pull-left"></div>\
